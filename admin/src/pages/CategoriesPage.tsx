...
import { getCategories, upsertCategory, deleteCategory } from '../services/api'
...
export function CategoriesPage() {
  ...
  const saveMut = useMutation({
    mutationFn: (data: Partial<Category> & { name: string; slug: string }) =>
      upsertCategory(data),
    onSuccess: () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmDialog
        ...
        description="Products in this category will have their category cleared. This cannot be undone."
        confirmLabel="Delete"
        danger
